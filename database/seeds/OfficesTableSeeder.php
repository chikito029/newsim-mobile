...
class OfficesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Office::create([
            ...
            "photo_url" => "offices-cover/cover_bacolod.jpg",
        ]);
        Office::create([
            "name" => "NEWSIM Cebu",
            ...
            "photo_url" => "offices-cover/cover_cebu.jpg",
        ]);
        Office::create([
            ...
            "photo_url" => "offices-cover/cover_cebu_annex.jpg",
        ]);
        Office::create([
            ...
            "photo_url" => "offices-cover/cover_talisay.jpg",
        ]);
        Office::create([
            "name" => "NEWSIM Davao",
            ...
            "photo_url" => "offices-cover/cover_davao.jpg",
        ]);
        Office::create([
            "name" => "NEWSIM Ilo-ilo",
            ...
            "photo_url" => "offices-cover/cover_iloilo.png",
        ]);
        Office::create([
            ...
            "photo_url" => "offices-cover/cover_marconi.jpg",
        ]);
        Office::create([
            ...
            "photo_url" => "offices-cover/cover_makati.png",
        ]);
        Office::create([
            ...
            "photo_url" => "offices-cover/cover_nta.jpg",
        ]);
    }
}
