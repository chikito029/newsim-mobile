        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal" action="{{ route('promos.store') }}" enctype="multipart/form-data" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="panel-body" id="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        <input id="startDate" type="text" class="form-control" name="start_date" value="{{ old('start_date') ?: \Carbon\Carbon::now()->startOfMonth()->format('m/d/Y') }}"/>
                                        <span class="input-group-addon add-on"> - </span>
                                        <input id="endDate" type="text" class="form-control" name="end_date" value="{{ old('end_date') ?: \Carbon\Carbon::now()->endOfMonth()->format('m/d/Y') }}"/>
                                    </div>
